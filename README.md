...
<div>
      <svg
        ...
        aria-labelledby="descId"
      >
        <title id="titleId">TypicalModMaker's GitHub Stats, Rank: B</title>
        <desc id="descId">Total Stars Earned: 97, Total Commits in 2024 : 50, Total PRs: 29, Total Issues: 17, Contributed to (last year): 11</desc>
        <style>
          .header {
            font: 600 18px 'Segoe UI', Ubuntu, Sans-Serif;
            fill: #2f80ed;
